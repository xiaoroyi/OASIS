...
def main():
    ...
    parser.add_argument("--output_path", default="../data/ag_news/predictions.json")
    ...
    for item, prediction in zip(input_data_list, predictions):
        target_label = LABEL_MAP[item["label"]]
        prediction_lower = prediction.lower()
        is_correct = target_label.lower() in prediction_lower or (
            target_label == "Sci/Tech" and "sci" in prediction_lower
        )

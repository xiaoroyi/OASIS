...
echo "The value of TOP_K is: $TOP_K"
...
CUDA_VISIBLE_DEVICES=0 python train.py \
	...
	--bf16 True \
	--output_dir ckpt/alignment/${path_after_slash}_oasis_${RHO}_${TOP_K}_${epoch} \
...
CUDA_VISIBLE_DEVICES=0 python poison/evaluation/pred.py \
	--lora_folder ckpt/alignment/${path_after_slash}_oasis_${RHO}_${TOP_K}_${epoch} \
	--model_folder ${model_path} \
	--output_path data/poison/alignment/${path_after_slash}_oasis_${RHO}_${TOP_K}_${epoch} \
	--beaverTails_dataset_path ${beaverTails_dataset_path}

CUDA_VISIBLE_DEVICES=0 python poison/evaluation/eval_sentiment.py \
	--input_path data/poison/alignment/${path_after_slash}_oasis_${RHO}_${TOP_K}_${epoch} \
